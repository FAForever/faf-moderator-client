...
@Mapper(componentModel = "spring", uses = {JavaFXMapper.class, UniqueIdMapper.class, NameRecordMapper.class, BanInfoMapper.class, AvatarAssignmentMapper.class, AccountLinkMapper.class, CycleAvoidingMappingContext.class})
